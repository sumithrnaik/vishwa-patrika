"""
Django settings for vishwa_patrika project.
...
SECRET_KEY = 'django-insecure-xa523@!x72p%8^rc3!4!y6p70pve=*(497($0x%6ky@+fv=n=-'
...
WSGI_APPLICATION = 'vishwa_patrika.wsgi.application'
